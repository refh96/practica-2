...
function Dashboard() {
  ...
  const createProduct = async (e) => {
    ...
    try {
      const res = await axios.post("https://www.ranchomarket.site/productos", {
        ...product,
  ...
  const loadImage = async (productId) => {
    ...
    try {
      ...
      await axios.post(`https://www.ranchomarket.site/cargar_foto/${productId}`, formData, {
        headers: {
  ...
  const fetchProducts = async () => {
    try {
      const [perro, gato, otros, medicamentos] = await Promise.all([
        axios.get("https://www.ranchomarket.site/productos?txtBuscar=perro"),
        axios.get("https://www.ranchomarket.site/productos?txtBuscar=gato"),
        axios.get("https://www.ranchomarket.site/productos?txtBuscar=otros"),
        axios.get("https://www.ranchomarket.site/productos?txtBuscar=medicamentos"),
      ]);
  ...
  const handleDelete = async (productId) => {
    ...
    try {
      await axios.delete(`https://www.ranchomarket.site/productos/${productId}`);
      setProducts(prevProducts =>
        Object.fromEntries(
          Object.entries(prevProducts).map(([key, prods]) =>
              ...
              <Grid item xs={12} sm={6} md={4} key={producto.id}>
                <Card>
                  <CardContent>
                    ...
                    <Image
                      src={`https://www.ranchomarket.site/fotografias/${producto.url_foto || `${producto.id}.jpg`}`}
